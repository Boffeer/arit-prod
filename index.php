...
?>
                  <div class="meetups-item meetups-item--seminar">
                    <picture class="meetups__picture">
											<img src="<?php the_field('meetup_pic', $id) ?>"/>
                    </picture>
                    <div class="meetup-info">
										<h3 class="meetup__title"><?php the_field('meetup_name', $id) ?></h3>
                      ...
                      <div class="meetup-buttons">
											<button data-to-form="Заявка на семинар <?php the_field('meetup_name', $id) ?>" class="meetup__primary-button primary-button seminar__button-cta">Принять участие</button>
                    ...
                    <div class="meetup-info">
                      ...
                      <div class="meetup-buttons">
                        <button class="meetup__primary-button primary-button webinar__button-cta">Принять участие</button>
												<a href="<?php the_permalink($id) ?>" class="meetup__secondary-button thirdly-button webinar__button-more">Подробнее</a>
                      </div>
                    </div>
<?php } // end of webinar ?>
...
?>
                ...
                <div class="news-item swiper-slide"><a href="<?php the_permalink($id) ?>">
                    <picture class="news__picture">
										<img src="<?php the_field('news_hero', $id)?>"/>
                    </picture></a>
