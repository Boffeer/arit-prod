...
?>
        <h1 class="section__title section__title--page section__title--center">Обучение</h1>
      </div>
      <div class="learning learning-page" id="learning">
        <div class="container">
          <div class="learning-tabs-wrap">
            <div class="learning-tab--retrain">
              <h3 class="learning-page-title">Профессиональная переподготовка</h3>
        ...
        <div class="container">
          <div class="learning-tabs-wrap learning-tabs-wrap--skillup">
            <div class="learning-tab--skillup">
              <h3 class="learning-page-title">Повышение квалификации</h3>
