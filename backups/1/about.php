    ...
    <main class="subpage subpage--about">
      ...
      <div class="about-wrap" id="about">
        <div class="about-container container">
          <div class="about">
            <h2 class="section__title section__title--left about__title">Сведения об образовательной орагнизации</h2>
          ...
          <picture class="about-picture about-page-hero">
            <source srcset="img/pages/about/about-page-hero.webp 1x,<?php echo get_template_directory_uri()?>/img/pages/about/about-page-hero@2x.webp 2x" type="image/webp"/><img style="object-fit: cover;" src="img/pages/about/about-page-hero.png" srcset="img/pages/about/about-page-hero@2x.png 2x"/>
          </picture>
        </div>
        <picture class="about-picture__left">
          <source srcset="img/3-about/horse-l.webp 1x,<?php echo get_template_directory_uri()?>/img/3-about/horse-l@2x.webp 2x" type="image/webp"/><img src="img/3-about/horse-l.png" srcset="img/3-about/horse-l@2x.png 2x"/>
        </picture>
        <picture class="about-picture__right">
          <source srcset="img/3-about/apolo-r.webp 1x,<?php echo get_template_directory_uri()?>/img/3-about/apolo-r@2x.webp 2x" type="image/webp"/><img src="img/3-about/apolo-r.png" srcset="img/3-about/apolo-r@2x.png 2x"/>
        </picture>
      </div>
    </main>
<?php get_footer();?>
