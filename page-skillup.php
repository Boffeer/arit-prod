...
?>
					...
					<h1 class="section__title section__title--left"><?php the_title() ?></h1>
            ...
            <div class="sticky-form-right">
              ...
              <div class="form-fields">
                <div class="form-input-wrap">
								...
								<input type="hidden" name="arit_formname" value="Заявка на консультацию по курсу ПП <?php the_title() ?>"/>
                </div>
                <div class="form-input-wrap">
