...
<?php get_header();?>
    <main class="subpage">
      <div class="container">
        ...
        <div class="breadcrumbs"><a class="breadcrumb breadcrumb--main" href="#">Главная</a><a class="breadcrumb" href="#">Об академии</a><a class="breadcrumb" href="#">Документы</a></div>
        ...
        <div class="licenses-list">
                    <div class="licenses-item">
                      <div class="licenses-item-text">
                        <p class="licenses-item__title">Правила приема на обучение, 2021 год</p>
                    ...
                    <div class="licenses-item">
                      <div class="licenses-item-text">
                        <p class="licenses-item__title">Положение о реализации дополнительных профессиональных программ в Автономной</p>
                        <p class="licenses-item__size">1Мб</p>
                      </div>
                      <button class="licenses-item-download"> <span class="licenses-item-download__text">Скачать PDF</span>
                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="licenses-item">
                      <div class="licenses-item-text">
                        <p class="licenses-item__title">Финансово-хозяйственная деятельность</p>
                        <p class="licenses-item__size">1Мб</p>
                      </div>
                      <button class="licenses-item-download"> <span class="licenses-item-download__text">Скачать PDF</span>
                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
