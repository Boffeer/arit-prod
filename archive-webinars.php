...
?>
	<div class="meetup-next-item" data-url="<?php echo $post['url'] ?>" data-src="<?php echo $post['meetup_pic'] ?>" data-address="<?php echo $post['meetup_address'] ?>" data-date="<?php echo $post['time'] ?>">
...
<?php foreach ($postsToArchieve as $post) { ?>

            <div class="archieve-item">
              <div class="archieve-item-picture">
								<a href="<?php echo $post['meetup_link'] ?>" class="archieve-play">
									<svg class="archieve-play" width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path d="M22 0C9.86846 0 0 9.86941 0 22C0 34.1306 9.86846 44 22 44C34.1315 44 44 34.1306 44 22C44 9.86941 34.1315 0 22 0ZM30.7459 22.7708L17.9126 31.0208C17.7623 31.1183 17.5886 31.1667 17.4167 31.1667C17.2663 31.1667 17.1141 31.1291 16.9781 31.0548C16.6826 30.8937 16.5 30.5857 16.5 30.25V13.75C16.5 13.4143 16.6826 13.1063 16.9781 12.9452C17.2681 12.7859 17.6315 12.7957 17.9126 12.9792L30.7459 21.2292C31.0074 21.3975 31.1667 21.6885 31.1667 22C31.1667 22.3115 31.0074 22.6024 30.7459 22.7708Z" fill="white"></path>
									</svg>
								</a>
              ...
              <div class="archieve-item__controls">
								<a href="<?php echo $post['meetup_link'] ?>" class="archieve__cta"><span>Запись</span>
